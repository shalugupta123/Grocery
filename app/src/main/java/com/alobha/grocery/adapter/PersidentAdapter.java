...
public class PersidentAdapter extends BaseAdapter {
	private LayoutInflater mInflater;

	ArrayList<userdata> userdatas;

	public PersidentAdapter(Activity mcontext,
			ArrayList<userdata> userDatas) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.ratbbb=(RatingBar)convertView.findViewById(R.id.rb_rats);
